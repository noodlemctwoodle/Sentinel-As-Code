...
.EXAMPLE
    ./Tools/New-DcrFromClassicTable.ps1 -ResourceGroupName rg-sentinel `
...
function Build-DcrArmTemplate {
    ...
    return @{
        ...
        metadata       = [ordered] @{
            description = "Data collection rule for $OutputStream, generated by New-DcrFromClassicTable.ps1."
        }
        resources      = @(
            [ordered] @{
