...
The exporter ([`Scripts/Documenter/Export-SentinelInventory.ps1`](../../Scripts/Documenter/Export-SentinelInventory.ps1),
...
[`88-sentinel-data-lake.md`](../../Scripts/Documenter/Convert-SentinelInventoryToMarkdown.ps1)
...
`cost-meters.json` catalogue ([`Scripts/Documenter/Private/Resources/cost-meters.json`](../../Scripts/Documenter/Private/Resources/cost-meters.json)),
...
- **Lake-resident asset detection breadth.** The asset-data block detects
  ...
  pattern list in [`Convert-SentinelInventoryToMarkdown.ps1`](../../Scripts/Documenter/Convert-SentinelInventoryToMarkdown.ps1)
...
| File | Role |
|---|---|
| [`Scripts/Documenter/Export-SentinelInventory.ps1`](../../Scripts/Documenter/Export-SentinelInventory.ps1) | `Try-Capture 'sentinel-data-lake'` (Resource Graph query) |
| [`Scripts/Documenter/Convert-SentinelInventoryToMarkdown.ps1`](../../Scripts/Documenter/Convert-SentinelInventoryToMarkdown.ps1) | Section 88 emit block (`Write-Section '88-sentinel-data-lake.md'`) |
| [`Scripts/Documenter/Private/Get-SentinelCostEstimate.ps1`](../../Scripts/Documenter/Private/Get-SentinelCostEstimate.ps1) | DataLake plan handling in the cost split |
| [`Scripts/Documenter/Private/Resources/cost-meters.json`](../../Scripts/Documenter/Private/Resources/cost-meters.json) | Lake meter → category mapping |
| [`Scripts/Documenter/Private/Get-EffectiveConnectors.ps1`](../../Scripts/Documenter/Private/Get-EffectiveConnectors.ps1) | Asset-table family inference (`_ActiveTableFamily`) |
