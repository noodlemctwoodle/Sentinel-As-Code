...
| [`Scripts/Documenter/Private/Resources/commitment-tiers.json`](../../Scripts/Documenter/Private/Resources/commitment-tiers.json) | Workspace commitment-tier pricing breakpoints |
...
& ./Scripts/Documenter/Convert-SentinelInventoryToMarkdown.ps1 `
    ...
    -ResourcesRoot  ./Scripts/Documenter/Private/Resources
```
