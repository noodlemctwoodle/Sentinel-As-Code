...
| `New-ClassicTableFixture.ps1` | Rehearsal aid: creates a throwaway classic `_CL` table with synthetic data via the Data Collector API (and can stream it) | See [Tools/ClassicToDcr/README.md](../../Tools/ClassicToDcr/README.md) |
| `Test-DcrIngestion.ps1` | Rehearsal aid: streams synthetic data into a migrated DCR via the Logs Ingestion API to confirm it ingests | See [Tools/ClassicToDcr/README.md](../../Tools/ClassicToDcr/README.md) |
