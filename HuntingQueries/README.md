...
Hunting queries appear in **Microsoft Sentinel > Hunting** and can be run directly from the portal, bookmarked, or promoted to analytics rules if they identify high-signal behaviour worth automating.
